...
export default function StaffHero() {
  return (
    <section className="relative w-full py-28 md:py-40 text-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6">
        ...
        <h1 className="text-4xl md:text-6xl font-extrabold text-white leading-tight mb-6">
          ...
          <span className="block text-[#80A8FF]">Directly Employed Teams</span>
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mt-14">
          ...
          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 shadow-md border border-white/10">
            <Users className="w-10 h-10 text-[#80A8FF] mx-auto mb-3" />
            <p className="text-3xl font-bold text-white">1200+</p>
            <p className="text-gray-200 text-sm font-medium">Active Employees</p>
          </div>

          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 shadow-md border border-white/10">
            <GraduationCap className="w-10 h-10 text-[#80A8FF] mx-auto mb-3" />
            <p className="text-3xl font-bold text-white">Internal</p>
            <p className="text-gray-200 text-sm font-medium">Training Academy</p>
          </div>

          <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 shadow-md border border-white/10">
            <ShieldCheck className="w-10 h-10 text-[#80A8FF] mx-auto mb-3" />
