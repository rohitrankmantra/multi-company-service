  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        ...
        >
          <div className="inline-block px-6 py-2 bg-blue-200/20 text-blue-100 font-semibold rounded-full mb-6 border border-blue-300/20">
          ...
          <div className="h-1 w-28 mx-auto bg-blue-400 rounded-full mb-8" />
          ...
          {sectors.map((sector, index) => (
            ...
            >
              <Link href={sector.href} className="block h-full">
                <Card className="cursor-pointer h-full bg-white/95 backdrop-blur-sm border-0 shadow-xl transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                  <CardHeader>
                    <div
